...
float sigma = 10;
float rho = 28;      //these are included in lorenz
float beta = 8/3;
float h = .005;
float* stepX[1000];
float* stepY[1000];
...
void display()
{
   ...
   case 2:
      glVertex3d(0.1,0.05,z);
      glVertex3d(0.3,0.075,z);
      glVertex3d(0.5,0.1,z);
      glVertex3d(0.7,0.25,z);
      glVertex3d(0.9,0.6,z);
      break;
   //  Three dimensions - variable Z
   case 3:
      // glVertex3d(0.1,0.1,1.1);
      // glVertex3d(0.3,0.3,3.2);
      // glVertex3d(0.5,0.5,3.9);
      // glVertex3d(0.7,0.7,4.5);
      // glVertex3d(0.9,0.9,4.9);
